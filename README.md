...
This branch contains the Odoo 17 edition.
...
The Odoo 17 backend regression suite contains 64 tests.
...
The frontend was also manually regression-tested on Odoo 17, including:
